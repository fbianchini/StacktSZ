...
factor  = {100:1, 160:1, 250:469./36., 350:831./64., 500:1804./144.} # Jy/beam -> Jy/pixel 
...
class CutoutAnalysis(object):
	def __init__(self, folder, lambdas=[250,350,500], patches=['G9','G12','G15'], zbins=[(1.0,5.0)], extras_names=['Z'], size=5.):
		if size == 5.:
			...
			self.boxsize = {100:99, 160:75, 250:51, 350:39, 500:27, 90:40}
			self.reso    = {100:3.,  # in arcsec
						    160:4.,  # in arcsec
						    250:6.,  # in arcsec
						    350:8.,  # in arcsec
						    500:12.} # in arcsec
			self.positions = {100: (49.5,49.5),
							 160: (37.5,37.5),
							 250: (25.5,25.5), 
							 350: (19.5,19.5), 
							 500: (13.5,13.5)}
